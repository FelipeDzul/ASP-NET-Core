...
namespace platzi_asp_net_core.Controllers
{
    public class AlumnoController : Controller
    {
        ...
        {
            ViewData["CursoId"] = new SelectList(_context.Cursos, "Id", "Nombre"); // "Id" es el valor a guardar, "Nombre" el valor a mostrar
            return View();
        }
        ...
        public async Task<IActionResult> Edit(string id)
        {
            ...
            //ViewData["CursoId"] = new SelectList(_context.Cursos, "Id", "Id", alumno.CursoId);
            //return View(alumno);
            ViewData["CursoId"] = new SelectList(_context.Cursos, "Id", "Nombre", alumno.CursoId); // "Id" es el valor a guardar, "Nombre" el valor a mostrar
            return View(alumno);
        }
